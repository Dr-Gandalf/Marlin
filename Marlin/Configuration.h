...
#define STRING_CONFIG_H_AUTHOR "(Jorge Castillo, 03/22/2023)" // Who made the changes.
 ...
 */
#define PIDTEMPBED
#define HEATER_BED_INVERTING true  //JC el rele esta invertido
...
#define DELTA
  ...
  #define DELTA_MAX_RADIUS       119.5    // (mm)

  // Center-to-center distance of the holes in the diagonal push rods.
  #define DELTA_DIAGONAL_ROD 253.5        // (mm)

  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 306.6             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 127.2              // (mm) Get this value from G33 auto calibrate
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 60, 60, 60, 120 }
...
#define NOZZLE_TO_PROBE_OFFSET { -23, 8, -2.4 }
...
#define HOMING_FEEDRATE_Z  (50*60)  // delta
